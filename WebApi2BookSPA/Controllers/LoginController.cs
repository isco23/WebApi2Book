...
namespace WebApi2BookSPA.Controllers
{
    public class LoginController : Controller
    {
        ...
        public const string Issuer = "crop";
        public const string Audience = "http://www.isco.com";
        // GET: Login
        ...
        private string CreateJwt(string userId , string role)
        {
            ...
            var credentials = new SigningCredentials(new InMemorySymmetricSecurityKey(key), "http://www.w3.org/2001/04/xmldsig-more#hmac-sha256",
"http://www.w3.org/2001/04/xmlenc#sha256");
            var expiration = DateTime.Now.AddMinutes(20).ToLongTimeString();
